        ...
        $('div.share42init').each(function (idx) {
            ...
            function ya_count(url) {
                ...
                $.getScript('http://wow.ya.ru/ajax/share-counter.xml?url=' + url, function () {
                    ...
                    if (shares > 0 || z == 1) el.find('a[data-count="ya"]').after('<span class="share42-counter">' + shares + '</span>')
                })
            }
            ya_count(u);
            if (!f) {
            ...
            var s = new Array('"#" data-count="fb" onclick="window.open(\'http://www.facebook.com/sharer.php?m2w&' + fbQuery + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÑŒÑÑ Ð² Facebook"', '"#" data-count="vk" onclick="window.open(\'http://vk.com/share.php?url=' + u + '&title=' + t + vkImage + '&description=' + d + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÑŒÑÑ Ð’ ÐšÐ¾Ð½Ñ‚Ð°ÐºÑ‚Ðµ"', '"#" data-count="odkl" onclick="window.open(\'http://www.odnoklassniki.ru/dk?st.cmd=addShare&st._surl=' + u + '&title=' + t + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð² ÐžÐ´Ð½Ð¾ÐºÐ»Ð°ÑÑÐ½Ð¸ÐºÐ¸"', '"#" data-count="gplus" onclick="window.open(\'https://plus.google.com/share?url=' + u + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÑŒÑÑ Ð² Google+"', '"#" data-count="twi" onclick="window.open(\'https://twitter.com/intent/tweet?text=' + t + '&url=' + u + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð² Twitter"', '"http://my.ya.ru/posts_add_link.xml?URL=' + u + '&title=' + t + '&body=' + d + '" data-count="ya" title="ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÑŒÑÑ Ð² Ð¯.Ñ€Ñƒ"', '"http://www.livejournal.com/update.bml?event=' + u + '&subject=' + t + '" title="ÐžÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ¾Ð²Ð°Ñ‚ÑŒ Ð² LiveJournal"');
            var l = '';
            ...
            function m() {
                ...
                } else if(ph - 100 < top + 225) {
                    p.parent().addClass('share42FixBottom');
                    console.log('bottom' +ph);
                } else {
                    p.parent().removeClass('share42FixBottom');
                    p.css({
                        top: m2
                    });
                }
